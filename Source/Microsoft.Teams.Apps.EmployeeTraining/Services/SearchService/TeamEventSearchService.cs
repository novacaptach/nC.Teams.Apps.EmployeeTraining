...
public class TeamEventSearchService : ITeamEventSearchService
{
    ...
    {
        searchParametersDto = searchParametersDto ?? throw new ArgumentNullException(paramName: nameof(searchParametersDto), message: "Search parameters are null");
