...
class RegisterRemoveEvent extends React.Component<
  IRegisterRemoveEventProps,
  IRegisterRemoveEventState
> {
      ...
      if (
        ...
        if (eventDetails.isLoggedInUserRegistered) {
          ...
          eventDetails.registeredAttendeesCount <
            eventDetails.maximumNumberOfParticipants &&
          eventDetails.canLoggedInUserRegister
        ) {
  ...
  onRegisterRemoveEvent = async () => {
    ...
    if (
      ...
      microsoftTeams.tasks.submitTask({
        isSuccess: true,
        type: this.state.eventOperationType,
      });
    } else {
      this.setState({
        isFailedToRegisterOrRemove: true,
        isOperationInProgress: false,
      });
    }
  };
