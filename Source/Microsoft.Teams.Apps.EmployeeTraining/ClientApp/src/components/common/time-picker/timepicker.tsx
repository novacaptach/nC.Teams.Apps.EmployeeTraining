    ...
    <div className="timepicker-popup-style">
      <Flex gap="gap.small">
        <Flex.Item size="size.half">
          <Text
            size={props.dir === LanguageDirection.Rtl ? "medium" : "small"}
            content={localize("hourPlaceholder")}
          />
        </Flex.Item>
        <Flex.Item
          size="size.half"
          className={
            props.dir === LanguageDirection.Rtl ? "rtl-right-margin-large" : ""
          }
        >
          <Text
            size={props.dir === LanguageDirection.Rtl ? "medium" : "small"}
            content={localize("minutePlaceholder")}
          />
        </Flex.Item>
      </Flex>
          ...
          <Dropdown
            className={
              props.dir === LanguageDirection.Rtl
                ? "timepicker-dropdown rtl-right-margin-small"
                : "timepicker-dropdown"
            }
            value={minutes}
            items={minutesItems}
