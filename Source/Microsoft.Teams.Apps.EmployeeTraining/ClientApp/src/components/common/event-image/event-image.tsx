...
const EventImage: React.FunctionComponent<IEventImage> = (props) => {
  ...
  const [isErrorLoadingImage, setImageError] = React.useState(false);
    ...
    <React.Fragment>
      <img
        className={`${props.className} ${
          isImageLoaded && !isErrorLoadingImage
            ? "event-image-renderer image-loaded"
            : "event-image-renderer image-not-loaded"
        }`}
        src={props.imageSrc}
