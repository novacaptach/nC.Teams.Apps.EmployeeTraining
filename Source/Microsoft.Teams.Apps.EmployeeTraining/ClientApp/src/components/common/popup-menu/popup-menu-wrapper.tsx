...
const PopupMenuWrapper: React.FunctionComponent<IPopupMenuWrapperProps> = (
  props
) => {
  ...
  if (props.checkboxes) {
      ...
      <Popup
          ...
          <Button
            data-testid={
              props.checkboxes.length > 0
                ? props.checkboxes[0].title + "_CheckboxButton"
                : "dummyTitle_CheckboxButton"
            }
        ...
        content={
          <PopupMenuCheckboxesContent
            ...
            content={{ checkboxes: props.checkboxes, title: props.title }}
    ...
    return (
      <Popup
          ...
          <Button
            data-testid={
              props.radioGroup.length > 0
                ? props.radioGroup[0].name + "_RadioGroupButton"
        ...
        content={
          <PopupMenuRadiogroupContent
            dir={props.dir}
            selectedValue={props.selectedSortBy!}
            content={{ radioGroupItems: props.radioGroup, title: props.title }}
            onRadiogroupStateChange={props.onRadiogroupStateChange}
          />
        }
        trapFocus
      />
