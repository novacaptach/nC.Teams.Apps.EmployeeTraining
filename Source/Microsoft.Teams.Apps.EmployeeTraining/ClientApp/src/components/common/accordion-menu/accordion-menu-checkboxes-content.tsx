...
const AccordionCheckboxesContent: React.FunctionComponent<IAccordionMenuCheckboxesContentProps> = (
  props
) => {
  ...
  const onCheckboxValueChange = (key: string, checked: boolean) => {
    ...
    const checkCount: number = checkboxList.reduce(
      (accumulator: number, checkbox: ICheckBoxItem) => {
