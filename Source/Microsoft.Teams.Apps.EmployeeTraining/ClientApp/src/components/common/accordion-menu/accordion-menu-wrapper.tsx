...
const AccordionMenuWrapper: React.FunctionComponent<IAccordionMenuWrapperProps> = (
  props
) => {
  ...
  if (props.checkboxes) {
    return (
      <div className="accordion-container">
        ...
        <AccordionCheckboxesContent
          isOpen={props.isFilterOpen}
          disableClear={props.selectedCount === 0}
    ...
    return (
      <div className="accordion-container">
        ...
        <AccordionRadiogroupContent
          isOpen={props.isFilterOpen}
          selectedValue={props.selectedSortBy!}
          content={{
            radioGroupItems: props.radioGroup,
            title: props.title,
          }}
