...
export const DatePickerStyles = (
  ...
  const HoverStyles = () => {
    return {
      ...
      ".ms-DatePicker-currentDecade:hover": {
        color: DarkTheme.palette.neutralPrimary,
      },
      ".ms-DatePicker-day--outfocus:hover": {
        ...TextHoverStyle(),
      },
      ".ms-DatePicker-monthAndYear:hover": {
        color: DarkTheme.palette.neutralPrimary,
      },
      ".ms-DatePicker-weekday:hover": {
        color: DarkTheme.palette.neutralPrimary,
      },
      ".ms-DatePicker-monthOption:hover": {
        ...TextHoverStyle(),
      },
      ".ms-DatePicker-header > .ms-DatePicker-currentYear:hover": {
        color: DarkTheme.palette.neutralPrimary,
      },
  ...
  return {
    callout: {
      ...
      selectors: {
        ...
        ".ms-DatePicker-yearOption--disabled": {
          color: DarkTheme.palette.neutralSecondary,
        },
        ...
        ".ms-DatePicker-nextDecade--disabled": {
          color: DarkTheme.palette.neutralSecondary,
        },
        ".ms-DatePicker-prevDecade--disabled": {
          color: DarkTheme.palette.neutralSecondary,
        },
