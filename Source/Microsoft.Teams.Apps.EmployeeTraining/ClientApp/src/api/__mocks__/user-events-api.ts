  ...
  let events: Array<IEvent> = [
    {
      ...
      graphEventId:
        "AAMkADBhZWQyNzAwLWMzYTMtNGIyZi04MzMwLWE1ZGRhNzAwNzUwNABGAAAAAAAZ6TOP56tHR7uCxRRJ2P4DBwC56vz5BTDmQpfmcre0NyZhAAAAAAENAAC56vz5BTDmQpfmcre0NyZhAACcfCrLAAA=",
      photo:
        "https://siddharthstorage.blob.core.windows.net/events-photos/91e5703b-139f-49fb-bcfb-b01ae1463c6b",
      ...
      selectedUserOrGroupListJSON:
        '[{"displayName":"All Employees","email":"Employees@M365x002616.OnMicrosoft.com","id":"1","isGroup":true,"isMandatory":true}]',
    ...
    },
    {
      ...
      updatedOn: new Date("2020-09-29T07:55:00.585825Z"),
      selectedUserOrGroupListJSON:
        '[{"displayName":"All Employees","email":"Employees@M365x002616.OnMicrosoft.com","id":"5a501b90-9fae-4e3c-b7bb-3f14a9e6fb84","isGroup":true,"isMandatory":true}]',
