...
public class BackgroundTaskWrapperHelper : IBackgroundTaskWrapperHelper, IDisposable
{
    ...
    /// </summary>
    public BackgroundTaskWrapperHelper()
    {
        this.taskCollection = new BlockingCollection<Task>();
    }
    ...
    {
        this.taskCollection.Add(item: task);
    }
    ...
    {
        return this.taskCollection.Take(cancellationToken: token);
    }
